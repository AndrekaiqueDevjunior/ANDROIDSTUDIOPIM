...
public class MainActivity extends AppCompatActivity {
    ...
    Button downloadButton; // Declaração do botão de download
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (LoginManager.loginUser(cpf, senha)) {
                    // CPF e senha corretos, abrir a próxima atividade (MainActivityHolerite)
                    Intent intent = new Intent(MainActivity.this, MainActivityHolerite.class);
        ...
        sairButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder confirmExitDialog = new AlertDialog.Builder(MainActivity.this);
